...
# a
print(f"а) {not (X1 or not Y1) or Z1}")
...
# в)
print(f"в) {not Z1 or not X1 or Y1}")
print(f"{not Z2 or not X2 or Y2}")
print(f"{not Z3 or not X3 or Y3}")
print(f"{not Z4 or not X4 or Y4}")
print(f"{not Z5 or not X5 or Y5}")
print(f"{not Z6 or not X6 or Y6}")